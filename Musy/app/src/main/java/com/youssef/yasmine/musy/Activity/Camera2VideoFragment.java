...
import com.youssef.yasmine.musy.Util.AutoFitTextureView;
import com.youssef.yasmine.musy.Util.CompareSizeByArea;
...
public class Camera2VideoFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        url = this.getArguments().getString("previewtrack");
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            ErrorDialog.newInstance("errror")
                   ...
                   // mMediaRecorder.start();
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            // UI
                           // mButtonVideo.setText("stop");
                            mButtonVideo.setBackgroundResource(R.drawable.circlered);
                            mIsRecordingVideo = true;
    ...
    private void stopRecordingVideo() {
        ...
        mButtonVideo.setBackgroundResource(R.drawable.circlewhite);
